      ...
      return this.sendEmailCode({
        ...
        .then((data) => {
          if(data.responseCode === 1001){
            ...
            this.tryingToReset = false
            this.error = data ? data.responseMessage : ''
      ...
      <div class="col-lg-5">
        <div class="card">
          ...
          <div class="card-body p-4">
            ...
            <b-form v-show="!isSend" @submit.prevent="sendMail" >
              ...
              <div class="form-group mb-0 text-center">
                <b-button type="submit" variant="primary">SendMail</b-button>
              </div>
            </b-form>

            <b-form v-show="isSend" @submit.prevent="reset" >
              <b-form-group id="email-group" label="Email address" label-for="email">
                <b-form-input
                  id="email"
                  v-model="email"
              ...
              <b-form-group id="code-group" label=" Code" label-for="code">
                ...
                <b-form-group id="newpassword-group" label="New Password" label-for="newpassword">
                <b-form-input
                  id="newPassword"
                  v-model="newPassword"
                  type="password"
